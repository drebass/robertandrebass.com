...
window.Typekit.config = {
    ...
    "dl": "AAAAVwAAAAoJXC81m4mXkgB1frU",
    "fi": [6817, 10296, 10300],
    "fc": [{
        "id": 6817,
        "family": "minion-pro",
        "src": "https://use.typekit.net/af/8b6d99/0000000000000000000151d6/21/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "subset_id": 2
        ...
        "src": "https://use.typekit.net/af/832a29/0000000000000000000132e3/21/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "700",
            "style": "normal",
            "subset_id": 2
        ...
        "id": 10300,
        "family": "brandon-grotesque",
        "src": "https://use.typekit.net/af/c6b579/0000000000000000000132dd/21/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "300",
            "style": "normal",
            "subset_id": 2
...
(function(window, document, undefined) {
    ...
    ga.prototype.has = function(a) {
        ...
        for (var b = "number" === typeof a, c = 0; c < this.i; c++) {
            var d;
            if (b)
                d = q(a & 4294967295, 3432918353), d = d << 15 | d >>> 17, d = q(d, 461845907), d ^= ha[c] || 0, d = d << 13 | d >>> 19, d = q(d, 5) + 3864292196, d ^= 4, d ^= d >>> 16, d = q(d, 2246822507), d ^= d >>> 13, d = q(d, 3266489909), d ^= d >>> 16, d = (d >>> 0) % this.b;
            else {
                d = ha[c] || 0;
                var e,
                    f,
