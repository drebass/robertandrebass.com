...
!function($) {
    ...
    for (var e, o = function() {}, t = ["assert", "clear", "count", "debug", "dir", "dirxml", "error", "exception", "group", "groupCollapsed", "groupEnd", "info", "log", "markTimeline", "profile", "profileEnd", "table", "time", "timeEnd", "timeStamp", "trace", "warn"], a = t.length, n = window.console = window.console || {}; a--;)
        e = t[a], n[e] || (n[e] = o)
}();
...
for (var handle = 0, draw = function() {
        ...
        if (e > 1)
            ...
            for (var o = 0; o < path.length; o++)
                path[o].style.strokeDashoffset = Math.floor(f_length[o] * (1 - e));
...
var s_handle = 0,
    draw2 = function() {
        ...
        if (e > 1)
            window.cancelAnimationFrame(s_handle);
        else {
            s_current_frame++;
            for (var o = 0; o < s_path.length; o++)
                s_path[o].style.strokeDashoffset = Math.floor(s_length[o] * (1 - e));
...
supportsTouch ? responsive_viewport >= 768 && (document.addEventListener("touchmove", ScrollStart, !1), document.addEventListener("scroll", Scroll, !1)) : $(window).scroll(function() {
    ...
    $(".socialtweets").load("tweets.html"), loaderContent.addClass("active"), setTimeout(function() {
